<template>
    <div class="page-sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Dashboard</span><span class="badge rounded-pill badge-primary">6</span><i class="fa fa-angle-right pull-right"></i></a>
