...
<div class="page-sidebar">
  ...
  <div class="sidebar custom-scrollbar">
    <div class="sidebar-user text-center">
      ...
      <p>{{ __('lang.General Manager') }}.</p>
    </div>
    <ul class="sidebar-menu">
      <li class="{{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}">
        <a class="sidebar-header" href="#"><i data-feather="home"></i><span>{{ trans('lang.Dashboard') }}</span>
        ...
        <ul class="sidebar-submenu">
          ...
          <li><a href="{{route('dashboard-ecommerce')}}" class="{{ Route::currentRouteName()=='dashboard-ecommerce' ? 'active' : '' }}"><i class="fa fa-circle"></i>E-commerce</a></li>
          <li><a href="{{route('dashboard-university')}}" class="{{ Route::currentRouteName()=='dashboard-university' ? 'active' : '' }}"><i class="fa fa-circle"></i>University</a></li>
          <li><a href="{{route('dashboard-bitcoin')}}" class="{{ Route::currentRouteName()=='dashboard-bitcoin' ? 'active' : '' }}"><i class="fa fa-circle"></i>Crypto</a></li>
          <li><a href="{{route('dashboard-server')}}" class="{{ Route::currentRouteName()=='dashboard-server' ? 'active' : '' }}"><i class="fa fa-circle"></i>Server</a></li>
          <li><a href="{{route('dashboard-project')}}" class="{{ Route::currentRouteName()=='dashboard-project' ? 'active' : '' }}"><i class="fa fa-circle"></i>Project</a></li>
        </ul>
      </li>
      
      <li class="{{request()->route()->getPrefix() == '/widgets' ? 'active' : '' }}">
        <a class="sidebar-header" href="#"><i data-feather="airplay"></i><span>@lang('lang.Widgets')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{ request()->route()->getPrefix() == '/color-version' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="disc"></i><span>Color Version</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          <li><a href="{{ route('color-layout-light') }}" class="{{ Route::currentRouteName()=='color-layout-light' ? 'active' : '' }}"><i class="fa fa-circle"></i>Layout Light</a></li>
          <li><a href="{{ route('color-layout-dark') }}" class="{{ Route::currentRouteName()=='color-layout-dark' ? 'active' : '' }}"><i class="fa fa-circle"></i>Layout Dark</a></li>
        </ul>
      </li>

      <li class="{{request()->route()->getPrefix() == '/sidebar' ? 'active' : '' }}"> <a class="sidebar-header" href="#"><i data-feather="sidebar"></i><span>Sidebar</span><i class="fa fa-angle-right pull-right"></i></a>
          <ul class="sidebar-submenu">
            <li><a href="{{ route('sidebar-compact') }}" class="{{ Route::currentRouteName()=='sidebar-compact' ? 'active' : '' }}"><i class="fa fa-circle"></i>Compact Sidebar</a></li>
            <li><a href="{{ route('sidebar-compact-small') }}" class="{{ Route::currentRouteName()=='sidebar-compact-small' ? 'active' : '' }}"><i class="fa fa-circle"></i>Compact Icon Sidebar</a></li>
            <li><a href="{{ route('hidden') }}" class="{{ Route::currentRouteName()=='hidden' ? 'active' : '' }}"><i class="fa fa-circle"></i>Sidebar Hidden</a></li>
            <li><a href="{{ route('sidebar-fixed') }}"><i class="fa fa-circle"></i>Sidebar Fixed</a></li>
            <li><a class="disabled" href="" onclick="return false;"><i class="fa fa-circle"></i>Disable</a></li>
          </ul>
      </li>

      <li class="{{request()->route()->getPrefix() == '/page-layout' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="layout"></i><span>Page layout</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          <li><a href="{{ route('box-layout') }}" class="{{ Route::currentRouteName()=='box-layout' ? 'active' : '' }}"><i class="fa fa-circle"></i>Boxed</a></li>
          <li><a href="{{ route('page-layout-rtl') }}" class="{{ Route::currentRouteName()=='page-layout-rtl' ? 'active' : '' }}"><i class="fa fa-circle"></i>RTL</a></li>
        </ul>
      </li>

  {{--     <li class="{{request()->route()->getPrefix() == '/menu-options' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="align-justify"></i><span>Menu Options</span><i class="fa fa-angle-right pull-right"></i></a>
          <ul class="sidebar-submenu">
              <li><a href="{{ route('menu-hide-on-scroll') }}"><i class="fa fa-circle"></i>Hide menu on Scroll</a></li>
              <li><a href="{{ route('menu-vertical') }}"><i class="fa fa-circle"></i>Vertical Menu</a></li>
              <li><a href="{{ route('mega-menu-option') }}"><i class="fa fa-circle"></i>Mega Menu</a></li>
              <li><a href="{{ route('menu-fix-header') }}"><i class="fa fa-circle"></i>Fix header</a></li>
              <li><a href="{{ route('menu-fix-header-sidebar') }}"><i class="fa fa-circle"></i>Fix Header & sidebar</a></li>
          </ul>
      </li> --}}

      <li class="{{request()->route()->getPrefix() == '/base' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="box"></i><span> @lang('lang.Base')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          ...
          <li><a href="{{route('according')}}" class="{{ Route::currentRouteName()=='according' ? 'active' : '' }}"><i class="fa fa-circle"></i>Accordion</a></li>
      ...
      <li class="{{request()->route()->getPrefix() == '/advance' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="folder-plus"></i><span>@lang('lang.Advance')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/animation' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="cloud-drizzle"></i><span>@lang('lang.Animation')<span class="badge badge-danger ms-3">Hot</span></span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/icons' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="command"></i><span>@lang('lang.Icons')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/buttons' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="cloud"></i><span>@lang('lang.Buttons')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/cards' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="book"></i><span>@lang('lang.Cards')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/timeline' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="sliders"></i><span>@lang('lang.Timeline')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/charts' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="bar-chart"></i><span>@lang('lang.Charts')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/maps' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="map"></i><span>@lang('lang.Maps')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{ in_array(Route::currentRouteName(), ['basic-template', 'email-header', 'template-email', 'template-email-2', 'ecommerce-templates', 'email-order-success']) ? 'active':''}}"><a class="sidebar-header" href="#"><i data-feather="printer"></i><span>@lang('lang.Email Templates')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/editors' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="git-pull-request"></i><span>@lang('lang.Editors')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/users' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="users"></i><span>@lang('lang.Users')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/calender' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="calendar"></i><span>@lang('lang.Calender')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li><a class="sidebar-header {{ Route::currentRouteName()=='internationalization' ? 'active' : '' }}" href="{{route('internationalization')}}"><i data-feather="aperture"></i><span>@lang('lang.Internationalization')</span></a></li>

      <li class="{{request()->route()->getPrefix() == '/gallery' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="image"></i><span>@lang('lang.Gallery')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/email' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="mail"></i><span>@lang('lang.Email')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/blog' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="edit"></i><span>@lang('lang.Blog')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/chat' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="message-square"></i><span>@lang('lang.Chat')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li><a class="sidebar-header {{ Route::currentRouteName()=='social-app' ? 'active' : '' }}" href="{{route('social-app')}}"><i data-feather="chrome"></i><span>@lang('lang.Social App')</span></a></li>

      <li class="{{request()->route()->getPrefix() == '/job-search' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="user-check"></i><span>@lang('lang.Job Search')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/learning' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="layers"></i><span>@lang('lang.Learning')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li><a class="sidebar-header {{ Route::currentRouteName()=='faq' ? 'active' : '' }}" href="{{route('faq')}}"><i data-feather="help-circle"></i><span>@lang('lang.FAQ')</span></a></li>

      <li><a class="sidebar-header {{ Route::currentRouteName()=='knowledgebase' ? 'active' : '' }}" href="{{route('knowledgebase')}}"><i data-feather="database"></i><span>@lang('lang.Knowledgebase')</span></a></li>

      <li><a class="sidebar-header {{ Route::currentRouteName()=='support-ticket' ? 'active' : '' }}" href="{{route('support-ticket')}}"><i data-feather="headphones"></i><span>@lang('lang.Support Ticket')</span></a></li>

      <li><a class="sidebar-header {{ Route::currentRouteName()=='to-do' ? 'active' : '' }}" href="{{route('to-do')}}"><i data-feather="mic"></i><span>@lang('lang.To-Do')</span></a></li>

      <li><a class="sidebar-header {{ Route::currentRouteName()=='landing-page' ? 'active' : '' }}" href="{{route('landing-page')}}" target="_blank"><i data-feather="navigation-2"></i><span>@lang('lang.Landing Page')</span></a></li>

      <li class="{{request()->route()->getPrefix() == '/ecommerce' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="shopping-bag"></i><span>@lang('lang.Ecommerce')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          ...
          <li><a href="{{route('list-products')}}" class="{{ Route::currentRouteName()=='list-products' ? 'active' : '' }}"><i class="fa fa-circle"></i>Product list</a></li>
      ...
      <li><a class="sidebar-header {{ Route::currentRouteName()=='pricing' ? 'active' : '' }}" href="{{route('pricing')}}"><i data-feather="dollar-sign"></i><span>@lang('lang.Pricing')</span></a></li>

      <li><a class="sidebar-header {{ Route::currentRouteName()=='sample-page' ? 'active' : '' }}" href="{{route('sample-page')}}"><i data-feather="file"></i><span>@lang('lang.Sample Page')</span></a></li>

      <li class="{{request()->route()->getPrefix() == '/search-pages' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="search"></i><span>@lang('lang.Search Pages')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/errors' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="alert-octagon"></i><span>@lang('lang.Error Pages')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/authentication' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="unlock"></i><span>@lang('lang.Authentication')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li class="{{request()->route()->getPrefix() == '/coming-soon' ? 'active' : '' }}"><a class="sidebar-header" href="#"><i data-feather="briefcase"></i><span>@lang('lang.Coming Soon')</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
      ...
      <li><a class="sidebar-header" href="{{route('maintenance')}}" class="{{ Route::currentRouteName()=='maintenance' ? 'active' : '' }}" target="_blank"><i data-feather="settings"></i><span>@lang('lang.Maintenance')</span></a></li>
    </ul>
  </div>
</div>
<!-- Page Sidebar Ends-->
